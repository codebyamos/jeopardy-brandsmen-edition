                ...
                {player.avatar && (
                  <div className="flex justify-center mb-1">
                    <img 
                      ...
                      className="w-6 h-6 sm:w-8 sm:h-8 rounded-full object-cover border border-white/30"
                    />
                  </div>
                )}
                <div className="font-bold text-sm sm:text-lg mb-1 sm:mb-2" style={{fontWeight: '400'}}>{player.name}</div>
