  ...
  return (
    <div className="bg-gray-900 border border-gray-700 rounded-lg overflow-hidden">
      <Button 
        ...
        className="w-full bg-gray-800 hover:bg-gray-700 text-yellow-400 border-0 rounded-none"
      >
        {isVisible ? 'Hide' : 'Show'} Player Management
      </Button>
      
      {isVisible && (
        <div className="p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-bold text-yellow-400">Manage Players</h3>
            <Button 
              onClick={addPlayer}
